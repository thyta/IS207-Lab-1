...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      <div class="container">
        <img class="nav-logo" src="img-header/Meubel House_Logos-05.png" alt="">
        <a class="navbar-brand" href="#">FURNIRO</a>
        <!-- middle -->
        <div class="navbar-nav mx-auto nav-font">
  ...
  <div class="Browse-the-range container text-center" style="padding:50px">
    <h3 class="bold">Browse The Range</h3>
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
    <div class="row">
      <div class="col">
        <img class="center thumbnail" style="max-width: 100%;" src="img-home/image 106 (1).png" alt="">
        <p>Dining</p>
      </div>
      <div class="col">
        <img class="center thumbnail" style="max-width: 100%;" src="img-home/image 106 (1).png" alt="">
  ...
  <!--End of Browse The Range-->

  <!--Our Product-->
  <div class="Our-products container">
    <h3 class="bold">Our Products</h3>

    <!--Begin Albumn-->
    <div class="album py-5 bg-body-tertiary container  bg-light " padding-bottom="10px">


      <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 g-4" padding="20px" margin="10px">
        <!--This is 1 Col-->
        <div class="col-2">
          <div class="card shadow-sm">

            <img width="100%" height="100%" src="img-home/image 1.png" alt="">
            <div class="card-body" align="left">
              <h6 class="card-text">Syltherine</h6>
              <p class="card-text">
                Stylish cafe chair
              </p>
              <div class="row">
                <h6 class="col-6">Rp 2.500.000 <span> </h6>
                <p class="col" style="color:gray; font-size: 10px;"><del>Rp 3.000.000</p>
              </div>
      ...
      <!--End of 1 Col-->
      <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 g-4" padding="20px">
        <!--This is 1 Col-->
        <div class="col-2">
          <div class="card shadow-sm">
    ...
    <div class="showmore container" align="center">Show More</div>
  ...
  <div class="room-inspiration container-fluid ">
    <div class="row" >
      <div class="col-4">
        <h1 style="padding:40% 5% 2% 10%; font-weight: 700;">50+ Beautiful rooms
          inspiration</h1>
        </h1>
        <p style="padding:0% 5% 2% 10%">Our designer already made a lot of beautiful prototipe of rooms that inspire you
        </p>
        <div class="explore">
          <h6>Explore More</h6>
        </div>
      ...
      <div class="col-1">
        <div class="explore-inside">
          <img src="img-home/Rectangle 25.png" margin-top=10% alt="">
        </div>
      </div>
    </div>
  ...
  <!--<div class="container-fluid" style="height: 600px; background: url(img-home/fial.png);background-repeat: no-repeat ;background-position: center;"> -->
  


  <!--End of Main content-->
  <!--Footer-->
  <div class="container-fluid" style="height:2px; background-color: gainsboro;"></div>

  <footer class="bg-white text-left text-black container">
    <!-- Grid container -->
    <div class="row footer-row">
      <div class="col-3">
        <h5  class="footer-brand " href="#">FURNIRO.</h5>
        <p class="footer-uni"style="color:#9F9F9F">400 University Drive Suite 200 Coral Gables,
          FL 33134 USA</p>
      </div>
      <div class="col-2">
      ...
      <div class="col-2">
        <p style="color:#9F9F9F">Helps<p>
        <p>Payment Options</p>
        <p>Returns</p>
        <p>Privacy Policies</p>
      </div>
      <div class="col">
        <p style="color:#9F9F9F">Newsletters<p>
  
        <div class="row">
          <div class="col-6">
            <div class="form-outline form-white mb-4">
              <input type="email" id="form5Example20" class="form-control" style="border: none; border-bottom: 1px solid #000;" placeholder="Enter your email address" />
            </div>
            
          </div>
          <div class="col-4">
            <div class="form-outline form-white mb-4">
              <input type="email" id="form5Example21" class="form-control" style="border: none; border-bottom: 1px solid #000;" placeholder="SUBCRIBE" />
            </div>  
          </div>
    ...
    <div class="container-fluid" style="height:2px; background-color: gainsboro;"></div>
    <p style="padding: 20px;padding-left: 0;">2023 furino. All rights reverved</p>
  </footer>
